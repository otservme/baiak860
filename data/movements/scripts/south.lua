...
wall1pos = {x=centerpos.x-1, y=centerpos.y-2, z=centerpos.z, stackpos=1}
wall2pos = {x=centerpos.x, y=centerpos.y-2, z=centerpos.z, stackpos=1}
wall3pos = {x=centerpos.x+1, y=centerpos.y-2, z=centerpos.z, stackpos=1}
wall4pos = {x=centerpos.x-1, y=centerpos.y-1, z=centerpos.z, stackpos=1}
wall5pos = {x=centerpos.x, y=centerpos.y-1, z=centerpos.z, stackpos=1}
wall6pos = {x=centerpos.x+1, y=centerpos.y-1, z=centerpos.z, stackpos=1}
wall7pos = {x=centerpos.x-1, y=centerpos.y, z=centerpos.z, stackpos=1}
wall8pos = {x=centerpos.x, y=centerpos.y, z=centerpos.z, stackpos=1}
wall9pos = {x=centerpos.x+1, y=centerpos.y, z=centerpos.z, stackpos=1}
...
wall9 = getThingfromPos(wall9pos)
		...
		playerpos1 = {x=centerpos.x-1, y=centerpos.y-2, z=centerpos.z, stackpos=253}
		playerpos3 = {x=centerpos.x+1, y=centerpos.y-2, z=centerpos.z, stackpos=253}
		playerpos7 = {x=centerpos.x-1, y=centerpos.y, z=centerpos.z, stackpos=253}
		playerpos9 = {x=centerpos.x+1, y=centerpos.y, z=centerpos.z, stackpos=253}
...
if status == 1 then
doPlayerSendCancel(cid,"south.") 
if wall1.itemid ~= 0 then
...
doRemoveItem(wall9.uid,1)
	...
	doCreateItem(1802, 1, tilepos9)
		...
		doTeleportThing(getplayer1.uid,tilepos1)
		doTeleportThing(getplayer3.uid,tilepos3)
		doTeleportThing(getplayer7.uid,tilepos7)
