...
wall1pos = {x=centerpos.x-2, y=centerpos.y-1, z=centerpos.z, stackpos=1}
wall2pos = {x=centerpos.x-1, y=centerpos.y-1, z=centerpos.z, stackpos=1}
wall3pos = {x=centerpos.x, y=centerpos.y-1, z=centerpos.z, stackpos=1}
wall4pos = {x=centerpos.x-2, y=centerpos.y, z=centerpos.z, stackpos=1}
wall5pos = {x=centerpos.x-1, y=centerpos.y, z=centerpos.z, stackpos=1}
wall6pos = {x=centerpos.x, y=centerpos.y, z=centerpos.z, stackpos=1}
wall7pos = {x=centerpos.x-2, y=centerpos.y+1, z=centerpos.z, stackpos=1}
wall8pos = {x=centerpos.x-1, y=centerpos.y+1, z=centerpos.z, stackpos=1}
wall9pos = {x=centerpos.x, y=centerpos.y+1, z=centerpos.z, stackpos=1}
...
doRemoveItem(wall9.uid,1)
	...
	doCreateItem(1802, 1, tilepos9)
		...
		doTeleportThing(getplayer4.uid,tilepos3)
		doTeleportThing(getplayer6.uid,tilepos9)
		doTeleportThing(getplayer7.uid,tilepos1)
		doTeleportThing(getplayer9.uid,tilepos7)
