...
wall1pos = {x=centerpos.x-2, y=centerpos.y-2, z=centerpos.z, stackpos=1}
wall2pos = {x=centerpos.x-1, y=centerpos.y-2, z=centerpos.z, stackpos=1}
wall3pos = {x=centerpos.x, y=centerpos.y-2, z=centerpos.z, stackpos=1}
wall4pos = {x=centerpos.x-2, y=centerpos.y-1, z=centerpos.z, stackpos=1}
wall5pos = {x=centerpos.x-1, y=centerpos.y-1, z=centerpos.z, stackpos=1}
wall6pos = {x=centerpos.x, y=centerpos.y-1, z=centerpos.z, stackpos=1}
wall7pos = {x=centerpos.x-2, y=centerpos.y, z=centerpos.z, stackpos=1}
wall8pos = {x=centerpos.x-1, y=centerpos.y, z=centerpos.z, stackpos=1}
wall9pos = {x=centerpos.x, y=centerpos.y, z=centerpos.z, stackpos=1}
...
if status == 1 then
doPlayerSendCancel(cid,"southeast.") 
