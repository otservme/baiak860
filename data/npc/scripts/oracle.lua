...
local node1 = keywordHandler:addKeyword({'yes'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'What city do you wish to live in? {Blood}?'})
	local node2 = node1:addChildKeyword({'Blood'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, town = 1, destination = {x=160, y=51, z=7}, text = 'Blood, eh? So what vocation do you wish to become? {Sorcerer}, {druid}, {paladin} or {knight}?'})
