...
shopModule:addBuyableItem({'heavy magic missile', 'hmm'},		2311, 15, 1,	'heavy magic missile rune')
shopModule:addBuyableItem({'great fireball', 'gfb'},			2304, 20, 1,	'great fireball rune')
shopModule:addBuyableItem({'explo', 'xpl'},				2313, 25, 1,	'explosion rune')
shopModule:addBuyableItem({'ultimate healing', 'uh'},			2273, 30, 1,	'ultimate healing rune')
shopModule:addBuyableItem({'sudden death', 'sd'},			2268, 35, 1,	'sudden death rune')
