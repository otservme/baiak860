function onUse(cid, item, frompos, item2, topos)
	wall1 = {x=1455, y=1554, z=11, stackpos=1}
	getwall1 = getThingfromPos(wall1)
	wall2 = {x=1455, y=1555, z=11, stackpos=1}
	getwall2 = getThingfromPos(wall2)
	wall3 = {x=1455, y=1556, z=11, stackpos=1}
	getwall3 = getThingfromPos(wall3)
	wall4 = {x=1455, y=1557, z=11, stackpos=1}
	getwall4 = getThingfromPos(wall4)
	wall5 = {x=1455, y=1558, z=11, stackpos=1}
